...
Pythonista iOS app of Bleak is written with
...
As stated above, this will however only work the iOS device that performed
...
.. automodule:: bleak-pythonista.backends.pythonistacb.scanner
    :members:

Client
^^^^^^

.. automodule:: bleak-pythonista.backends.pythonistacb.client
    :members:
