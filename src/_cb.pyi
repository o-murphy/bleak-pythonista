...
class Peripheral:
    ...
    def set_notify_value(self, characteristic, flag: bool = True): ...
    def write_characteristic_value(self, characteristic, data, with_response): ...
    def read_characteristic_value(self, characteristic): ...
